...
import { applyTheme, currentTheme, applyDensity, currentDensity, applyMode, currentMode, applyBgTint, currentBgTint, applySidebarMode, currentSidebarMode } from '@mds/theme.js'
