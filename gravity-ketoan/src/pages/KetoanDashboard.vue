...
const NAV_ROUTES = { tienmat: '/tien-mat', tiengui: '/tien-gui', banhang: '/ban-hang' }
function onNav(id) {
...
function initCharts() {
  ...
  const grid24    = { top: 8, right: 8, bottom: 32, left: 52 }
...
onMounted(() => {
  if (window.echarts) initCharts()
    ...
    const t = setInterval(() => { if (window.echarts) { initCharts(); clearInterval(t) } }, 100)
  }
