...
const widgets = ref([
  ...
  { id:'quick-actions', type:'quick-actions', colSpan:6, rowSpan:6, colStart:19, rowStart:5,  title:'Thao tác nhanh', source:'AMIS', icon:'sparkles', color:'#f79009', showSrc:false, data:{} },
  { id:'birthdays',     type:'birthdays',     colSpan:6, rowSpan:6, colStart:19, rowStart:11, title:'Sinh nhật',      source:'AMIS', icon:'gift',     color:'#f79009', showSrc:false, data:{} },
  { id:'notices',       type:'notices',       colSpan:6, rowSpan:6, colStart:19, rowStart:17, title:'Thông báo',      source:'AMIS', icon:'bell',     color:'#245fdf', showSrc:false, data:{} },
  { id:'top-sales',     type:'top-sales',     colSpan:6, rowSpan:6, colStart:19, rowStart:23, title:'Top bán hàng',   source:'AMIS', icon:'award',    color:'#12b76a', showSrc:false, data:{} },
  { id:'quick-links',   type:'quick-links',   colSpan:6, rowSpan:6, colStart:19, rowStart:29, title:'Liên kết nhanh', source:'AMIS', icon:'link',     color:'#7a5af8', showSrc:false, data:{} },
])
