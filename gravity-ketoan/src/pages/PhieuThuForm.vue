  ...
  <div class="phieu-thu-form">
    ...
    <div class="form-bar">
      <div class="form-bar__left">
        ...
        <div class="ibox form-bar__type">
          <input class="ibox__native" type="text" :value="voucherType" readonly />
          <button class="ibox__icon ibox__icon--action" type="button"><i class="ti ti-plus"></i></button>
          <button class="ibox__icon ibox__icon--action" type="button"><i class="ti ti-chevron-down"></i></button>
        </div>
        <div class="ibox form-bar__search">
          <i class="ti ti-search ibox__icon"></i>
          <input class="ibox__native" type="text" v-model="searchVoucher"
      ...
      <div class="form-bar__right">
        <button class="btn btn--outline btn--neutral" type="button">
          <i class="ti ti-help-circle" style="font-size:15px;color:var(--text-success)"></i>
          Hướng dẫn sử dụng
          <i class="ti ti-chevron-down" style="font-size:13px"></i>
        </button>
        <button class="btn-icon btn-icon--outline" type="button"><i class="ti ti-settings"></i></button>
        <button class="btn-icon btn-icon--outline" type="button" @click="emit('close')"><i class="ti ti-x"></i></button>
      </div>
    </div>
    ...
    <div class="form-body">
      ...
      <div class="form-fields">
        ...
        <div class="form-row">
          <div class="field form-col-1">
            ...
            <div class="ibox">
              <input class="ibox__native" type="text" v-model="form.maDT" />
              <button class="ibox__icon ibox__icon--action" type="button"><i class="ti ti-plus"></i></button>
              <button class="ibox__icon ibox__icon--action" type="button"><i class="ti ti-chevron-down"></i></button>
            </div>
          </div>
          <div class="field form-col-2">
            ...
            <div class="ibox"><input class="ibox__native" type="text" v-model="form.tenDT" /></div>
          </div>
          <div class="field form-col-3">
            <label class="field__label">Ngày hạch toán</label>
            <div class="ibox">
              <input class="ibox__native" type="text" v-model="form.ngayHachToan" style="width:88px" />
              <button class="ibox__icon ibox__icon--action" type="button"><i class="ti ti-calendar"></i></button>
            </div>
          </div>
        ...
        <div class="form-row">
          <div class="field form-col-1">
            ...
            <div class="ibox"><input class="ibox__native" type="text" v-model="form.nguoiNop" /></div>
          </div>
          <div class="field form-col-2">
            <label class="field__label">Địa chỉ</label>
            <div class="ibox"><input class="ibox__native" type="text" v-model="form.diaChi" /></div>
          </div>
          <div class="field form-col-3">
            <label class="field__label">Ngày phiếu thu</label>
            <div class="ibox">
              <input class="ibox__native" type="text" v-model="form.ngayPhieuThu" style="width:88px" />
              <button class="ibox__icon ibox__icon--action" type="button"><i class="ti ti-calendar"></i></button>
            </div>
          </div>
        ...
        <div class="form-row">
          <div class="field form-col-1">
            ...
            <div class="ibox">
              <input class="ibox__native" type="text" v-model="form.nhanVien" />
              <button class="ibox__icon ibox__icon--action" type="button"><i class="ti ti-plus"></i></button>
              <button class="ibox__icon ibox__icon--action" type="button"><i class="ti ti-chevron-down"></i></button>
            </div>
          </div>
          <div class="field form-col-2">
            ...
            <div class="ibox">
              <input class="ibox__native" type="text" v-model="form.lyDoNop" />
              <button class="ibox__icon ibox__icon--action" type="button" title="Chọn mẫu diễn giải">
          ...
          <div class="field form-col-4">
            ...
            <div class="ibox"><input class="ibox__native" type="text" v-model="form.soPhieuThu" /></div>
          </div>
        </div>
        ...
        <div class="hach-toan__header">
          ...
          <div class="hach-toan__header-right">
            ...
            <div class="ibox" style="width:140px">
              ...
              <i class="ti ti-chevron-down ibox__icon" style="font-size:13px;pointer-events:none;flex-shrink:0"></i>
            </div>
          </div>
        </div>
      ...
      <div class="dinh-kem">
        <div class="dinh-kem__header">
          <i class="ti ti-paperclip" style="font-size:16px;color:var(--icon-neutral)"></i>
