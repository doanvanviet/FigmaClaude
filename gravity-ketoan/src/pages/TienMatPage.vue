  ...
  <div class="app-shell">
    ...
    <div class="body-row">
      ...
      <div class="main-content">
        <!-- Phiếu thu form -->
        <PhieuThuForm v-if="showPhieuThuForm" @close="showPhieuThuForm = false" />

        <!-- Sub-nav tabs -->
        <div v-if="!showPhieuThuForm" class="sub-nav">
        ...
        <div v-if="!showPhieuThuForm" class="content-wrapper">
            ...
            <div class="data-panel data-panel--master">
              ...
              >
                ...
                <template #main-buttons>
                  <div class="btn-split">
                    <button class="btn btn--primary" @click="showPhieuThuForm = true"><TIcon name="plus" />Thêm thu tiền</button>
                    <button class="btn btn--primary btn-split__arrow"><TIcon name="chevron-down" /></button>
                  </div>
                  <div class="btn-split">
                    <button class="btn btn--outline btn--neutral"><TIcon name="plus" />Thêm chi tiền</button>
...
import PhieuThuForm         from './PhieuThuForm.vue'
...
const showPhieuThuForm = ref(false)
